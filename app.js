...
async function checkForUpdates() {
    ...
    try {
        const response = await MakeAuthenticatedRequest('https://69qcfumvgb.execute-api.ap-southeast-2.amazonaws.com/CheckVersion', {
            method: 'POST',
            headers: {
...
async function SendPushNotification(userId, title, body) {
    try {
        const response = await MakeAuthenticatedRequest('https://69qcfumvgb.execute-api.ap-southeast-2.amazonaws.com/SendPushNotification', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
